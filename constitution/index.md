...
Simulation rules, sourcing, and model diagrams live in **[research/index.md](../research/index.md)**. For the island, biomes, resource ledger, and extraction economy, read **[resources-and-geography.md](../research/resources-and-geography.md)**. Product staging for v1 gaps and nation-management systems: **[nation management roadmap](../.cursor/plans/nation_management_roadmap_a1b2c3d4.plan.md)** — before implementing a phase, read the matching Phase 0–4 research docs linked from the research index (stockpiles/flows, infrastructure/fiscal/services, housing/order/politics, trade/diplomacy/defense, macro metrics).
